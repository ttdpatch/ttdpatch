...
SETTEXT(CFG_MOREBUILDOPTIONS, "`%s' (%s) wà•cza dodatkowe opcje konstrukcyjne.  Zakodowane bitowo.")
...
SETTEXT(CFG_MORECURRENCIES,"`%s' (%s) wà•cza dodatkowe waluty i Euro.  Zakodowane bitowo, domyòlnie 0.")
...
SETTEXT(CFG_TOYLANDFEATURES, "`%s' (%s) uaktywnia funkcje generatora losowych gier, kt¢re normalnie s• wyà•czone dla rodzaju terenu 'toyland', np. latarnie morskie losowo rozmieszczone w pobliæu kraw©dzi mapy.  WartoòÜ zakodowana bitowo.")
...
SETTEXT(CFG_MOUSEWHEEL, "`%s' (%s) umoæliwia korzystanie z k¢àka myszy od przybliæania/oddalania widoku w wersji pod Windows.  Parametr: 0 - centralny punkt planszy pozostaje w centrum, 1 - punkt pod kursorem myszy pozostaje niezmieniony, jeòli to moæliwe (styl OpenTTD); +2 - 'bezpieczna' obsàuga (przybliæanie/oddalanie po 2 przeskokach); +4 - obsàuga starszych system¢w (wymagana dla niekt¢rych sterownik¢w i pod Windows 95).")
