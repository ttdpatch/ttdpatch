...
SETTEXT(LANG_FULLSWITCHES, "\n"
	  ...
	  "-Yo #, -Zm #:   énderung der Einstellungen bestimmter Features (siehe Anleitung)\n"
...
SETTEXT(CFG_PLANECRCTRL, "`%s' (%s) ermîglicht es einzustellen, wann Flugzeuge abstÅrzen kînnen.")
...
SETTEXT(CFG_DISASTERS, "`%s' (%s) ermîglicht die Wahl, welche Katastrophen passieren kînnen.")
...
SETTEXT(CFG_MISCMODS, "`%s' (%s) ermîglicht es, die Arbeitsweise bestimmter Features zu verÑndern..")
...
SETTEXT(CFG_MOREBUILDOPTIONS, "`%s' (%s) ermîglicht zusÑtzliche Baumîglichkeiten.")
...
SETTEXT(CFG_MORECURRENCIES,"`%s' (%s) aktiviert zusÑtzliche WÑhrungen und den Euro.")
...
SETTEXT(CFG_TOYLANDFEATURES, "`%s' (%s) aktiviert Landschaftsmerkmale, die in Toyland normal deaktiviert sind fÅr Zufallsspiele.")
...
SETTEXT(CFG_MOUSEWHEEL, "`%s' (%s) aktiviert das Mausrad in der Windowsversion.")
