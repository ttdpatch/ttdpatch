...
SETTEXT(LANG_WRONGVERSION, "\n"
	...
	"         abstÅrzen und es kann zu Datenverlusten kommen. Bitte lesen Sie\n"
	"         Abschnitt 4.13 in der Datei TTDPATCH.TXT fÅr weitere Informationen.\n"
	"\n"
...
SWITCHTEXT(aibooster, "Computer-Rekursion erhîhen", " um %d")
