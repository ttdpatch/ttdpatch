...
SETTEXT(LANG_FULLSWITCHES, "\n"
	  ...
	  "-Yo #, -Zm #:   Sommige opties van andere schakelopties wijzigen (zie documentatie)\n"
...
SETTEXT(CFG_PLANECRCTRL, "'%s' (%s) maakt het mogelijk te bepalen wanneer vliegtuigen kunnen neerstorten.")
...
SETTEXT(CFG_DISASTERS, "Met '%s' (%s) kun je kiezen welke rampen er kunnen gebeuren.")
...
SETTEXT(CFG_MISCMODS, "'%s' (%s) maakt het mogelijk om de werking van bepaalde andere schakelopties te wijzigen, lees de documentatie voor meer info.")
...
SETTEXT(CFG_MOREBUILDOPTIONS, "Met '%s' (%s) krijg je meer mogelijkheden bij bouwen.")
...
SETTEXT(CFG_MORECURRENCIES,"Met '%s' (%s) worden meer valuta mogelijk, waaronder de Euro.")
...
SETTEXT(CFG_TOYLANDFEATURES, "Met '%s' (%s) kun je landschapselementen gebruiken in willekeurige spellen in Speelgoedland die normaal zijn uitgeschakeld (bijv. vuurtorens).")
...
SETTEXT(CFG_MOUSEWHEEL, "Met '%s' (%s) kun je het muiswiel gebruiken in de Windows-versie.")
