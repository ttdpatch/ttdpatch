...
var railslopelevelled, db 30h,0Ch,1ah,30h,3fh,29h,3fh,0Ch,15h,3fh,3fh,26h,3fh,3fh
db 0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x0C,0xFF,0xFF,0xFF,0x30,0xFF,0x0C,0x30 	// and steep slopes
...
.done:
	mov esi, 1			//seems to work better than 6. 1 is original value
