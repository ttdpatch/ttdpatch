...
storeVehIDAndContinue:
	...
	inc	dword [esi+veh.cycle]
	cmp	dword [esi+6Ah], 0    //actually known as .field_6A in IDA
	retn
...
ovar .origfn, -4, $, drawTramTracksOnStation
    ...
    cmp	bl, 10h
    pop	bx
    jne	near .dontAddTramTracks
    //also check if L5 reports that we are in a bus stop!
