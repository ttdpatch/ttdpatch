...
/* Hacked again to work for TTDPatch by Dale McCoy <dalestan@gmail.com> */
...
static void *
memcpy (void *destaddr, void const *srcaddr, unsigned int len)
{
  char *dest = destaddr;
...
/* Put result from CTX in first 16 bytes following RESBUF.  The result is
   ...
   IMPORTANT: On some systems it is required that RESBUF is correctly
   aligned for a 32 bits value.  */
static void *md5_read_ctx __P ((const struct md5_ctx *ctx, void *resbuf));
