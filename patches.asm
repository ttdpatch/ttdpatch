...
//	patchproc largertowns,newtowngrowthrate, patchtowngrowthrate
	...
	patchproc fifoloading,generalfixes,newcargos,irrstations,cargodest,patchstation2array	// must be before patchnewhousedata (it checks for station2 availablity)
	...
	patchproc moretransopts, patchmoretransopts	// must be before patchnewstations
	// NOTE:
